module.exports = (img,compra,items, usuario) => {
    ...
    coberturas += "<tr>";       
        ...
        coberturas += "<td width='25%' class='com'>Artículo</td>";        
    ...
    for(var i in items){
        ...
        coberturas += "<td width='25%' class='cobes'>"+items[i].articulo.nombre+"</td>";        
        ...
        coberturas += "<td width='10%' class='cobi'>"+(parseFloat(items[i].valor) * parseFloat(items[i].cantidad))+"</td>";
        coberturas += "</tr>";
    }
        coberturas += "<tr>";               
        coberturas += "<td colspan='5'></td>";
